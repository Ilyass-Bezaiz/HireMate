        ...
        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
          <table class="w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              @else
              <tr>
                <td colspan="5" class="p-6 lg:text-2xl md:text-md text-md text-center dark:bg-gray-800 dark:text-neutral-200">No posts to show !</td>
              </tr>
              @endif
            </tbody>
          </table>
      ...
      <x-dialog-modal wire:model="showingModal">
        ...
        <x-slot name="content">
          <form enctype="multipart/form-data">
            ...
            <div class="sm:col-span-6 mb-4">
              <x-label for="expectedSalary">{{ __("Expected salary") }}</x-label>
              <div class="mt-1">
                <x-input type="text" wire:model.lazy="expectedSalary" id="expectedSalary" inputmode="numeric"
                  name="expectedSalary"
            ...
            <div class="bg-gray-100 rounded-md p-2 mb-4 dark:bg-transparent dark:p-0">
              ...
              <div class="flex gap-5 flex-col lg:flex-row md:flex-row">
                <div class="col-span-6 mb-4 w-full">
                  ...
                  <select wire:model.live="selectedCountry" id="country" name="country" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-green-400 sm:text-sm dark:bg-gray-900" autocomplete="country-name">
