                ...
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    ...
                    <table class="w-full divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-200 uppercase tracking-wider">Flexibility</th>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-200 uppercase tracking-wider">Requested Contract</th>
                        ...
                        @if (count($posts) > 0)
                                ...
                                <tr>
                                    ...
                                    <td class="flex gap-4 px-6 py-4 text-right text-sm">
                                        <x-button wire:click="showEditPostModal({{ $post->id }})" class="bg-gray-900 hover:bg-gray-600">EDIT</x-button>
                                        <x-button wire:click="deletePost({{ $post->id }})" class="bg-red-700 hover:bg-red-600">DELETE</x-button>
                                    </td>   
                                </tr>
                                @endforeach
                        @else
            ...
            <form enctype="multipart/form-data">
                ...
                <div class="bg-gray-100 rounded-md p-2 mb-4">
                    ...
                    <div class="flex gap-5 flex-col lg:flex-row md:flex-row">
                        ...
                        <div class="col-span-6 w-full">
                                    ...
                                    <select id="city" wire:model.live="cityId" name="city" autocomplete="city-name" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                ...
                <div class="col-span-6 w-full mb-4">
                    <label for="contractType" class="block text-sm font-medium text-gray-700">Contract type</label>
                        <select id="contractType" name="contractType" autocomplete="contractType-name" wire:model.live="contractType" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                ...
                <div class="col-span-6 w-full">
                    <label for="flexibility" class="block text-sm font-medium text-gray-700">Flexibility</label>
                        <select id="flexibility" wire:model.live="flexibility" name="flexibility" autocomplete="flexibility-name" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
