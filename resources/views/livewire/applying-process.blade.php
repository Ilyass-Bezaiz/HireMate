                    ...
                    <div>
                        ...
                        <div class="sm:col-span-6 mb-4">
                            <label for="phone" class="block text-sm font-medium text-gray-700 dark:text-white"> Phone
                                Number</label>
                            <div class="mt-1">
                                <input type="text" wire:model="phone" id="phone" inputmode="numeric"
                                    name="phone"
                    ...
                    <div>
                        <div class="sm:col-span-6 mb-4">
                            <div class="mt-4">
                                @if ($resumeUrl == null)
                                    <x-label for="resume"
                                        class="mb-2 inline-block text-neutral-700 dark:text-neutral-200">Resume</x-label>
                                ...
                                @if ($resumeUrl)
                                    <x-label for="resume"
                                        class="mb-2 inline-block text-neutral-700 dark:text-neutral-200">Resume already
                                        uploaded</x-label>
                                    <div
                                        class="relative text-[15px] flex items-center w-full min-w-0 rounded border border-solid border-neutral-300">
                                        <span
                                            class="bg-gray-200 h-full border-r-2 dark:bg-white dark:text-black p-3">Your
                                            Resume</span>
                                        <span
                                            class=" text-neutral-700 dark:text-neutral-200 p-3">{{ auth()->user()->name }}'s
                                            resume</span>
                                        <div class="flex-grow"></div>
                                        <!-- This will make the SVG take up the remaining space -->
                                        <svg class="w-6 h-6 mr-3" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg" stroke="#4DD783">
                    ...
                    <div>
                        <div class="sm:col-span-6 mb-4">
                            ...
                            <div class="mt-3">
                                ...
                                @if ($resumeUrl != null)
                                    <a href="/storage/uploads/cv-{{ auth()->user()->name }}.pdf" target="_blank"
                                        class="flex items-center h-6 px-4
