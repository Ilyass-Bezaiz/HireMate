<div class="py-10 px-28 dark:*:text-gray-200">
    ...
    <div class="flex justify-between flex-wrap gap-4 my-12">        
        ...
        <div wire:click='selectCard(2)' wire:loading.class='opacity-50' wire:target='selectCard(2)' class="flex flex-col gap-2 border-[1px] border-gray-400 hover:border-gray-600 hover:scale-[1.01] duration-200 {{ $selectedCard == 2 ? "border-gray-600" : null }} rounded-md w-80 px-8  py-4 cursor-pointer">
            <span>
    ...
    @elseif($this->selectedCard == 2)
        <livewire:partials.card-slider :cardContent="$favOffers" />
