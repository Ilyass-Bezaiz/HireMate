<div wire:model.live="showingModal" class="dark:*:text-gray-300" id="offer-description">
    <div class="flex items-center ml-[5%]">
        ...
        <div class="btns flex items-center flex-1 gap-2 justify-end mr-1">
            ...
            <span wire:loading.class='scale-90 opacity-50 duration-200' wire:target='addFav({{ $postId }})'
                wire:click='addFav({{ $postId }})'
