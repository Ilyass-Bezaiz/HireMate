<div class="dark:bg-gray-900">
    <div class="flex px-12 py-4">
        <div class="job-name">
            <h3 class="text-lg font-bold text-[var(--color-primary)]">Software developer jobs</h3>
            <p class="text-base font-light text-gray-400">Showing 30 out of 307</p>
        </div>
        <div class="flex justify-end flex-1">
            <button class="flex gap-4 px-6 h-10 font-bold bg-gray-200 dark:bg-gray-900 text-gray-500 dark:text-gray-400 rounded-full border-[1px] border-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 duration-200 shadow-sm" id="btn-filters">
                <span class="my-auto">
    ...
    <div class="flex align-top m-10 mb-20 gap-6">
        <div id="offers-list-container" class="blur-dev list-content-container flex-1 md:max-h-[585px] overflow-hidden md:overflow-y-scroll pr-[3%]">
            <ul class="list-content list-none">
                ...
                <li id="post-{{ self::$postId++ }}" wire:click="showOfferDetails({{$offer->id}})" class="{{ $offer->id-1 == self::$selectedPostId ? "checked" : "unchecked" }} cursor-pointer hover:translate-x-1 duration-200 py-[4%] px-[5%] border-b-[0.5px] border-gray-300 dark:border-gray-600 dark:text-gray-300">
                    <div class="ic-name-rating-like flex justify-start items-center gap-[3%]">
                        <img class="rounded-full w-10 h-10 shadow-xl" src="{{ $employers[$offer->id-1]->logo }}" alt="{{ "img_" . $employers[$offer->id-1]->companyName }}">
                        ...
                        <div class="flex justify-end flex-1">
                            <span class="ic-like rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 p-1.5 duration-200 cursor-pointer">
                                <img wire id="ic-like-{{ self::$postId }}" class="ic-heart" src="images/ic-empty-heart.png" alt="ic-heart" width="30" height="30">
                            </span>
                        </div>
                    </div>
                    <div class="flex">
                        <div class="flex flex-col flex-1">
                            ...
                            <span class="font-light text-gray-400 mt-[2%]">{{ $offer->flexibility }}</span>
                            <span class="font-medium text-[var(--color-primary)] mt-[1%]">{{'$'. $offer->salary }}</span>
                        </div>
                        <div class="flex flex-1 justify-end items-end">
                            <span class="font-thin text-gray-400 text-[14px]">10 days ago</span>
                        </div>
                    </div>
                </li>
                @endforeach           
        ...
        <div class="blur-dev content-details flex-1 max-w-[50%] max-h-[585px] border-l border-gray-400 overflow-y-scroll hidden md:block" id="offer-description">
            <div class="flex items-center ml-[5%]">
                <img class="rounded-full w-10 h-10 shadow-xl" src="@foreach ($employers as $employer) {{ $offers[self::$selectedPostId]->user_id == $employer->user_id ? $employer->logo : null }} @endforeach" alt="{{ "img_" . $employers[$offer->id-1]->companyName }}">
                ...
                <div class="btns flex items-center flex-1 gap-2 justify-end mr-1">
                    <span class="rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 p-1.5 duration-200 cursor-pointer">
                        <img class="ic-heart" src="images/ic-report.png" alt="ic-heart" width="30" height="30">                            
                    </span>
                    <span class="rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 p-1.5 duration-200 cursor-pointer">
                        <img class="ic-heart" src="images/ic-empty-heart.png" alt="ic-heart" width="30" height="30">                            
                    </span>
            ...
            <span class="text-[14spanx] font-light text-gray-400 ml-[5%]">{{ $offers[0]->flexibility }}</span>
