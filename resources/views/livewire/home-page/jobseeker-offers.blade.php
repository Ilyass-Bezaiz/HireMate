  ...
  <div class="flex align-top m-10 mb-20 gap-6">
    <div id="offers-list-container"
      ...
      <ul class="list-content list-none">
        ...
        <li id="post-{{ self::$postId++ }}" wire:click="showOfferDetails({{$offer->id}})"
          ...
          <div class="ic-name-rating-like flex justify-start items-center gap-[3%]">
            <img class="rounded-full w-10 h-10 shadow-xl" src="{{ $employers[$offer->id-1]->logo }}"
            ...
            <div class="flex justify-end flex-1">
              <span
                ...
                <img wire id="ic-like-{{ self::$postId }}" class="ic-heart" src="images/ic-empty-heart.png"
    ...
    <div
      ...
      <div class="flex items-center ml-[5%]">
        <img class="rounded-full w-10 h-10 shadow-xl"
          src="@foreach ($employers as $employer) {{ $offers[self::$selectedPostId]->user_id == $employer->user_id ? $employer->logo : null }} @endforeach"
          alt="{{ "img_" . $employers[$offer->id-1]->companyName }}">
